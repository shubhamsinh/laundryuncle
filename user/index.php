                ...
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0" style="height: 100px;">
                    <div class="d-inline-flex">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">M.G.Vasahat, Gota, Ahmedabad</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-primary mb-4 mb-lg-0" style="height: 100px;">
                    <div class="d-inline-flex text-left">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">brahmanidrycleaners@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0" style="height: 100px;">
                    <div class="d-inline-flex text-left">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">+91 99043 95080</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container pt-0 pt-lg-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 pl-lg-5">
                    ...
                    <h1 class="mb-4">We Are Quality Laundry Provider In Ahmedabad</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 m-0 my-lg-5 pt-0 pt-lg-5 pr-lg-5">
                    ...
                    <p>This the main reason why choose laundry service today. Our company has some professional workers. They clean any types of clothes or materials safely. Most of our employees are professional trained, so at least they have good skills and knowledge. Many of them have a lot of experience in cleaning any clothes safely. You should be able to maintain the quality of your clothes when you use our professional laundry service.
</p>
                    <div class="row">
