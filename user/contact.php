                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                                ...
                                <h5 class="font-weight-medium m-0 mt-2">M.G.Vasahat, Gota, Ahmedabad</h5>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                                ...
                                <h5 class="font-weight-medium m-0 mt-2">brahmanidrycleaners@gmail.com</h5>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex flex-column align-items-center justify-content-center text-center mb-5">
                                ...
                                <h5 class="font-weight-medium m-0 mt-2">+91 99043 95080</h5>
                            </div>
                        </div>
                    </div>
                </div>
